...
export default function Home({ onNavigateToBook, onApplyPromoCode }) {
  ...
  const offers = [
    ...
    {
      id: 5,
      title: 'Reliable Samsung',
      subtitle: 'Batteries',
      code: 'SAMSUNG',
      type: 'light',
      icon: <span style={{ fontWeight: 900, fontFamily: 'Arial, sans-serif', fontSize: '10px', color: 'var(--primary)', letterSpacing: '0.5px' }}>SAMSUNG</span>
    },
    {
      id: 2,
          ...
          >
            {offers.map((offer) => (
              <div
                ...
                style={offer.code === 'SAMSUNG' ? { flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '8px', padding: '12px' } : {}}
              >
                {offer.code === 'SAMSUNG' ? (
                  <>
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', padding: '0 8px' }}>
                      <img src="/samsung_logo.png" alt="Samsung Logo" style={{ width: '100%', height: 'auto', maxHeight: '50px', objectFit: 'contain' }} />
                    </div>
                    <span style={{ fontSize: '12px', color: 'var(--primary)', fontWeight: '700', whiteSpace: 'nowrap', paddingBottom: '4px' }}>Reliable Samsung Batteries</span>
                  </>
                ) : (
                  <>
      ...
      <div className="section-container" style={{ marginTop: '12px', paddingBottom: '24px' }}>
        ...
        <div style={{ backgroundColor: 'white', borderRadius: '16px', padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px', boxShadow: 'var(--shadow-sm)', border: '1px solid var(--border)', textAlign: 'left' }}>
          ...
          <div style={{ borderBottom: '1px solid var(--border)', paddingBottom: '8px' }}>
            ...
            <p style={{ fontSize: '12px', color: 'var(--text-sub)', marginTop: '4px', lineHeight: '1.4' }}>Yes! The first 4 services (each within a span of 3 months from the date of purchase of your EV bike from our dealership) will be absolutely free.</p>
          </div>
          <div>
